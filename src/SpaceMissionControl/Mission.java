...
public class Mission {
    ...
    public Mission (Program program, int missionNumber, String description, SpaceCraft spaceCraft, int cargoMass, int operationalFuelMass, int cargoModulesFuelMass, int planetEscapeFuelMass,){
